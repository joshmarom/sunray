...
import { Box, Paper, SimpleGrid, Stack, Title, useMantineColorScheme } from '@mantine/core';
...
export const DayCard = React.forwardRef<HTMLDivElement, Props>(
    ...
    const Today = React.useCallback<() => React.ReactNode>(() =>
        ...
        <Paper {...props} ref={ref}>
            ...
            >
                ...
                <Box>
                    ...
                    <Today />
                    <Title ta="center" size="h6">{dayOfMonth} {month}</Title>
                </Box>
            </Stack>
        </Paper>
    );
